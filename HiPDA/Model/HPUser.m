...
- (id)initWithAttributes:(NSDictionary *)attributes {
    ...
    if (avatar) {
        if (![avatar isEqualToString:@"000/00/00/00"]) {
            _avatarImageURLString = [NSString stringWithFormat:@"http://cnc.hi-pda.com/forum/uc_server/data/avatar/%@_avatar_small.jpg", avatar];
        ...
        _avatarImageURLString = [NSString stringWithFormat:@"http://cnc.hi-pda.com/forum/uc_server/data/avatar/000/%02ld/%02ld/%02ld_avatar_small.jpg", a, b, c];
        _avatarImageURL = [NSURL URLWithString:_avatarImageURLString];
    }
...
+ (NSURL *)avatarStringWithUid:(NSInteger)_uid {
    ...
    NSString *avatarImageURLString = [NSString stringWithFormat:@"http://cnc.hi-pda.com/forum/uc_server/data/avatar/000/%02ld/%02ld/%02ld_avatar_small.jpg", a, b, c];
